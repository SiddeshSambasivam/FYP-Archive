...
@click.option(
    ...
    help="Name of environment to sample",
)
@click.option(
    "--n_episodes", type=int, default=1000, help="Number of episodes to sample."
)
@click.option(
    "--n_samples", type=int, default=10000, help="Number of transitions to save."
)
