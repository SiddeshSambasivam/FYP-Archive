...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--reward_shaping",
        type=float,
        help="Coefficient for reward shaping. Set to 0 to turn off reward shaping.",
        default=1,
    )
    parser.add_argument(
        "-continuous",
        "--continuous",
        help="Whether or not to use continuous action space.",
        action="store_true",
    )
    ...
    demo_heuristic_lander(
        CustomLunarLander(
            reward_shaping_coef=args.reward_shaping, continuous=args.continuous
        ),
        render=True,
    )
